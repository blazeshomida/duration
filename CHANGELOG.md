...
Add baseline project files for licensing, documentation, and changelog automation.
...
Introduce a GitHub Actions CI pipeline to verify code quality and release readiness.
